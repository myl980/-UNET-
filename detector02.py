...
module = r'models\attention_512_32_bce03_5.pkl'
...
dataloader = DataLoader(mydatasets.MKDataset(path), batch_size=1, shuffle=True)
...
for i, (xs, ys) in enumerate(dataloader):
    ...
    out_img.save(os.path.join(out_img_path, '{}.png'.format(batch)))
    target_img.save(os.path.join(target_img_path, '{}.png'.format(batch)))
    batch += 1
